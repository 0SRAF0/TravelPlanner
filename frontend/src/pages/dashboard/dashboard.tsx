...
import TripCodeModal from './components/TripCodeModal.tsx';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="lg:hidden space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Start Planning</h3>
              <Button text="Create Trip" onClick={() => setShowCreateModal(true)} size="lg" />
            </div>
          </div>
        ...
        <div className="hidden lg:flex lg:gap-8">
          ...
          <div className="lg:w-[30%] space-y-6">
            ...
            {/* Create Trip */}
            <div className="bg-white rounded-2xl shadow-md p-6 space-y-4">
              <h3 className="text-xl font-bold text-gray-900">Start Planning</h3>
              <Button text="Create Trip" onClick={() => setShowCreateModal(true)} size="lg" />
            </div>
          </div>
