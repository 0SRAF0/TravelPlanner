...
export default function ActivityCard({ activity, onVote, className, modalMaxWidth = '672px' }: ActivityCardProps) {
  ...
  return (
    <>
      {/* Simple Card */}
      <div
        className={`transition-all duration-200 rounded-2xl shadow-md cursor-pointer select-none hover:shadow-xl hover:scale-[1.02] ${
          className || ''
        }`}
        ...
        role="button"
      >
        <div className="p-6 text-left h-full flex flex-col" style={{ color: colorSet.secondary }}>
          {/* Title */}
          ...
          {/* Vote Buttons - Square and Right Aligned */}
