...
class Activity(BaseModel):
	...
	category: str = Field(..., description="One of Food, Nightlife, Adventure, Culture, Relax, Nature, Other")
	rough_cost: Optional[int] = Field(default=None, description="Approx per-person cost")
	duration_min: Optional[int] = Field(default=None, description="Approx duration in minutes")
	lat: Optional[float] = Field(default=None, description="Latitude if known")
	lng: Optional[float] = Field(default=None, description="Longitude if known")
